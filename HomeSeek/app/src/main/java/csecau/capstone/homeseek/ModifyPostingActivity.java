...
public class ModifyPostingActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userView = (TextView)findViewById(R.id.postingUser);
...
//                        Toast.makeText(getApplicationContext(), "Favorites", Toast.LENGTH_LONG).show();
        ...
        userView.setText(intent.getStringExtra("estateid"));
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            case R.id.action_edit:
                ...
                intent.putExtra("manage", String.valueOf(manageView.getText()));
                intent.putExtra("area", String.valueOf(areaView.getText()));
